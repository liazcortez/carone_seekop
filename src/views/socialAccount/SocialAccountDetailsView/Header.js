...
const Header = ({ className, socialAccount, ...rest }) => {
    ...
    >
      ...
      <SimpleDialog open={open} onClose={handleClose} />
        ...
        >
          ...
          <Link
            variant="body1"
            color="inherit"
            to="/app/management/socialAccounts"
        ...
        <Typography
          ...
          color="textPrimary"
        >
          {socialAccount && socialAccount.name}
        </Typography>
      </Grid>
      <Grid item>
      ...
      { user && user.role === 'rockstar' ? (
       <> <Button
          ...
          variant="contained"
          component={RouterLink}
          to={`/app/management/socialAccounts/${socialAccount && socialAccount._id}/edit`}
          startIcon={
            <SvgIcon fontSize="small">
              <EditIcon />
            </SvgIcon>
