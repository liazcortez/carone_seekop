...
const Compose = ({isMailOpen, setMailOpen, store}) => {
  ...
  useEffect(() => {
      setMail({ ...mail, global: omsGlobal._id, email: omsGlobal.email})
    //eslint-disable-next-line
  }, [omsGlobal]);
  ...
  useEffect(() => {
      ...
      if(omsGlobal.store)
      getDocumentsByStore(omsGlobal.store._id)
    //eslint-disable-next-line
  }, [omsGlobal])
